    ...
    <div class="container">
        <div class="row">
            <div class="form-outline mb-3 d-flex flex-column flex-lg-row justify-content-lg-between">
                <asp:LinkButton ID="btnRegresar" runat="server" CssClass="btn-skin text-decoration-none " Text="<i class='bi bi-backspace'> Regresar</i>" CausesValidation="false"></asp:LinkButton>
            ...
            <div class="row mt-5">
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <asp:TextBox runat="server" ID="txtDescripcion" TextMode="MultiLine" Rows="7" CssClass="form-select"></asp:TextBox>
                </div>
